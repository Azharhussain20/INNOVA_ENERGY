...
open class SSCircularRingSlider: UIView {
    ...
    var startAngle: CGFloat = 115
    var endAngle: CGFloat = 65
    ...
    // MARK: - Initial setup of ring slider
    ...
    // MARK: - Create textfield of slider
    fileprivate func createValueTextField() {
        ...
        txtValue.center = CGPoint(x: midViewX, y: midViewY - 30)
    ...
    ///
    // MARK: - Returns: radius in CGFloat
    ...
    // MARK: -  Create endpoints of slider
    ...
    // MARK: -  This method will find the distance between two angles and returns it.
    ///
    /// - Parameters:
    ...
    ///
    // MARK: -  Parameter angleRadian: angle in radian
    ...
    ///
    // MARK: -  Parameter newValue: updated value
    ...
    // MARK: -  Updates the values of slider
    ...
    ///
    // MARK: - Parameter newAngle: updated angle
    ...
    // MARK: - This method updates gradient layer
    fileprivate func updateGradientLayer() {
        gradientLayer.frame = self.bounds
        gradientLayer.mask = outerRingShape
    }
    
    // MARK: - This method sets size of knob imagge
    ...
    ///
    // MARK: - Parameter sender: minus button
    ...
    ///
    // MARK: - Parameter sender: plus button
    ...
    ///
    // MARK: -  Parameter recognizer: pan gesture
...
extension SSCircularRingSlider {
    ...
    ///
    /// - Parameters:
    // MARK: - labelFont: font for label textColor: color of text label
    ...
    ///
    /// - Parameters:
    // MARK: - knobSize: size of knob knonbImage: knob image
    ...
    ///
    /// - Parameters:
    // MARK: - innerCirlce: inner ring color - outerCircle: outer ring color
    ...
    ///
    /// - Parameters:
    // MARK: - shadowColor: shadow color - radius: shadow radious
    ...
    ///
    /// - Parameters:
    // MARK: - startPointColor: starting button color - endPointColor: ending button color - knobColor: knob color
    ...
    ///
    /// - Parameters:
    // MARK: - color: shadow color - opacity: shadow opacity - offset: shadow offset - radius: shadow radious
    ...
    ///
    /// - Parameters:
    // MARK: - startPointImage: starting button image endPointImage: ending button image
    ...
    ///
    /// - Parameters:
    // MARK: - initialValue: initial value - minValue: minimum value - maxValue: maximum value
    ...
    ///
    // MARK: - Parameter colors: array of CGColor it has to be consists of minimum two values
    ...
    ///
    // MARK: - Parameters: - innerRingWidth: inner ring width - outerRingWidth: outer ring width
